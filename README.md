...
<b>作业二、word的排版艺术（pdf格式）</b>
<a href="关注点分离在计算思维和软件工程中的方法论意义.pdf" target="_blank">→点此下载</a><br>
...
PS：<br>/*作业二由于大多数浏览器可直接浏览PDF文件，故可能没有“下载”的效果*/<br>
  /*作业五中“我的家乡网页版”在部分浏览器可能无法运行，可能会提示下载，但文件格式也是网页的一种格式*/<br><br>
